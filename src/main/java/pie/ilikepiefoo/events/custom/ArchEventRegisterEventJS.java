...
public class ArchEventRegisterEventJS implements KubeEvent {
    ...
    public String register(String name, Class<?> eventProvider, String fieldName) {
        ...
        EventAdapter<?> adapter = new EventAdapter<>(pair.getA(), name, AdditionalEvents.ARCH_STARTUP_EVENT_HANDLER,
                AdditionalEvents.ARCH_SERVER_EVENT_HANDLER, AdditionalEvents.ARCH_CLIENT_EVENT_HANDLER);
