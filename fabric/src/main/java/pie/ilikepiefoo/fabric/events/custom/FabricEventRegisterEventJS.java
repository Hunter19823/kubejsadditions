...
public class FabricEventRegisterEventJS extends EventJS {
    ...
    public String register( String name, Class<?> eventProvider, String fieldName ) {
        ...
        EventAdapter<?> adapter = new EventAdapter<>(pair.getA(), name, FabricEventsJS.FABRIC_STARTUP_EVENT_HANDLER,
                                                     FabricEventsJS.FABRIC_SERVER_EVENT_HANDLER, FabricEventsJS.FABRIC_CLIENT_EVENT_HANDLER);
